...
import subprocess
subprocess.call(["pip3", "install", "py-cryptonight"])
subprocess.call(["pip3", "install", "requests"])
subprocess.call(["pip3", "install", "git+https://github.com/jtgrassie/pyrx.git#egg=pyrx"])




import socket,select,binascii,pycryptonight,pyrx,struct,json,sys,os,time
from multiprocessing import Process, Queue


pool_host = 'pool-at.supportxmr.com'
pool_port = 3333
pool_pass = 'Py'
wallet_address = '44ZTa9oC6HBQsTFmZm1CRXddgQWKF4DRiEWUefhnQ8LUiRmryxtZdyW4AcDcPKhxkLVW4Muh2KgSmVAbiddA6SziDr5MQPJ'
